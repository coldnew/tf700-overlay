...
# $Header: /var/cvsroot/gentoo-x86/www-client/firefox/firefox-21.0.ebuild,v 1.4 2013/06/10 04:04:55 anarchy Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/fix_nsabs_error.patch
	epatch "${FILESDIR}"/fix_acem_neon_arm-21.patch
