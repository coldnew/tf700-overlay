...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/xkeyboard-config/xkeyboard-config-2.8.ebuild,v 1.2 2013/02/25 08:42:24 zmedico Exp $
...
src_prepare() {
	epatch "${FILESDIR}"/tf700dock.patch

        # copy tf700dock to work/
	cp "${FILESDIR}"/tf700dock "${S}"/keycodes/
